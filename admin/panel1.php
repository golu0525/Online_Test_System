...
<div class="tab">
  ...
  <button class="tablinks" onclick="openpanel(event, 'Courseedit')">Edit Modules</button>
...
<div id="Courseedit" class="tabcontent">
  ...
  <div class="box-div">
    <h3>Edit Module</h3>
    <div class="picker2">
      <a href="Addmod.php" class="btn-mod txt-decor">Add Module</a>
    </div>
    <div class="co-form">
...
<div id="Editques" class="tabcontent box-div">
  ...
  <div class="icons">
    <form class="" method="post">
      ...
      <input type="submit" name="selectsearch" class="button" value="Search"/>
    </form>
    ...
    if ($FEC->num_rows > 0) {
     ...
     <div class="box-check1" >
       <ul style="display: block;">
          <li>Q<?php echo $i;?>.<?php echo $wo['question'];?><a href="del.php?question=<?php echo $wo['question']; ?>" style="margin-left: 920px;">Delete</a><a href="editanyques.php?question=<?php echo $wo['question']; ?>" class="button">update any</a></li>

          <li> A.<?php echo $wo['option_one']; ?></li>
         <li> B.<?php echo $wo['option_two']; ?></li>
         <li> C.<?php echo $wo['option_three']; ?></li>
         <li> D.<?php echo $wo['option_four']; ?><br></li>
             <li>Correct Ans:<?php echo $wo['crt_ans']; ?></li><br>
       </ul>
...
<div id="Result" class="tabcontent">
  <h3>Result</h3>
  <div class="usermode" style="margin-bottom: 10px;">
    <?php
if($rst->num_rows > 0){
  ?>
